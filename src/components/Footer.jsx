    ...
    <footer className="flex flex-col items-center bg-main">
      <div className="my-8 mb-12 flex h-[6vh] w-[min(20vw,220px)] items-center justify-around gap-6">
        <a
          ...
          href="https://www.instagram.com/prometheus.visuals?igsh=bmprMXF0a3gyZnll"
          target="_blank"
        ...
        <a
          aria-label="Contacta con nosotros a través de Whatsapp"
          href="https://wa.me/34639412229"
          target="_blank"
          rel="noopener noreferrer nofollow"
          className="flex h-full aspect-square items-center justify-center"
        >
          <svg
            role="img"
            viewBox="0 0 24 24"
            className="h-full fill-secnd hover:fill-[#25D366]"
          >
